...
from fake_stake.base_test import HOTCHAIN_FakeStakeTest

class zHOTXwrappedSerialsTest(HOTCHAIN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zHOTXs..." % DENOM_TO_USE)
