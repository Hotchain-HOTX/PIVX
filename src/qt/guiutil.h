...
/** Utility functions used by the HOTCHAIN Qt UI.
 */
namespace GUIUtil
{
...
// Render HOTCHAIN addresses in monospace font
...
// Parse "hotchain:" URI into recipient object, return true on successful parsing
