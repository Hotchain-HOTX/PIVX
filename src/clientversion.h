...
#error Client version information missing: version is not defined by hotchain-config.h or in any other way
#endif
...
/**
 * hotchaind-res.rc includes this file, but it cannot cope with real c++ code.
