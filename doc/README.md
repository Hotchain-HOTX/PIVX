...
Development
---------------------
The Hotx repo's [root README](https://github.com/Hotchain-HOTX/HOTCHAIN/blob/master/README.md) contains relevant information on the development process and automated testing.
